		...
		var c = /\blang(?:uage)?-([\w-]+)\b/i,
			...
			E = {
				...
				highlightAllUnder: function (e, t, a) {
					...
					for (var r, s = e.querySelectorAll(n.selector), i = 0; (r = s[i++]); )
						E.highlightElement(r, !0 === t, n.callback)
				},
				highlightElement: function (e, t, a) {
					for (var n, r = 'none', s = e; s && !c.test(s.className); ) s = s.parentNode
					s && ((r = (s.className.match(c) || [, 'none'])[1].toLowerCase()), (n = E.languages[r])),
						(e.className = e.className.replace(c, '').replace(/\s+/g, ' ') + ' language-' + r),
						e.parentNode &&
							((s = e.parentNode),
							/pre/i.test(s.nodeName) &&
								(s.className = s.className.replace(c, '').replace(/\s+/g, ' ') + ' language-' + r))
					function i(e) {
						;(l.highlightedCode = e),
					...
					var l = { element: e, language: r, grammar: n, code: e.textContent }
		...
		if (
			...
			(N.stringify = function (e, t) {
				...
				if (Array.isArray(e))
					return e
						.map(function (e) {
							return N.stringify(e, t)
						})
						.join('')
				var a = {
					type: e.type,
					content: N.stringify(e.content, t),
					tag: 'span',
				...
				E.hooks.run('wrap', a)
				var r = Object.keys(a.attributes)
					.map(function (e) {
						...
						(l.onreadystatechange = function () {
							4 == l.readyState &&
								(l.status < 400 && l.responseText
									...
									: 400 <= l.status
									? (i.textContent = '✖ Error ' + l.status + ' while fetching file: ' + l.statusText)
