...
import { loadAvailableProjects } from '../../components/Modal/contents/ProjectManager'
...
export class AppEditorStore {
	...
	constructor(store: Store, initialState?: InitialStoreState<AppEditorStore>) {
		...
		if (typeof window !== 'undefined') this.queryParams = parseParamsToObject(window.location.search)
