...
export default React.forwardRef<HTMLDivElement, GridProps>(function Grid(
	{ as, children, className, col, revert, full, nowrap, space, justify, items, ...props }: GridProps,
	ref,
) {
	const Tag = as || 'div'
	return (
