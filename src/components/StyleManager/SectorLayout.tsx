...
const iAlignSB =
	'M2 6v12h6V6H2zm0 13v5H1V0h1v5h6c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1H2zM16 6v12h6V6h-6zm6-1V0h1v24h-1v-5h-6a1 1 0 01-1-1V6c0-.6.4-1 1-1h6z'
const iAlignSA =
	'M11 0h1v24h-1V0zM1 6h6v12H1V6zm0-1h6c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1H1a1 1 0 01-1-1V6c0-.6.4-1 1-1zm15 1h6v12h-6V6zm0-1h6c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1h-6a1 1 0 01-1-1V6c0-.6.4-1 1-1z'
const iAlignSE =
	'M3 6v12h6V6H3zm0-1h6c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1H3a1 1 0 01-1-1V6c0-.6.4-1 1-1zM0 0h1v24H0V0zm14 6v12h6V6h-6zm0-1h6c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1h-6a1 1 0 01-1-1V6c0-.6.4-1 1-1zm8-5h1v24h-1V0zM11 0h1v24h-1V0z'
...
export default function SectorLayout({ sector }: Props) {
	...
	const optionsDir = [
		...
		{
			id: 'row-reverse',
			label: <Icon path={mdiArrowRight} size={iconSizeS} horizontal />,
			title: t('direction.title.row-reverse'),
		},
		{ id: 'column', label: <Icon path={mdiArrowDown} size={icon.sx} />, title: t('direction.title.column') },
		{
			id: 'column-reverse',
			label: <Icon path={mdiArrowDown} size={iconSizeS} vertical />,
			title: t('direction.title.column-reverse'),
		},
	]
	const optionsJust = [
		{
			...
			label: (
				<Icon
					...
					size={iconSizeS}
					rotate={isRow ? 0 : 90}
					horizontal={isRow && isDirRev}
					vertical={!isRow && isDirRev}
				/>
			),
		},
		...
		},
		{
			id: 'space-between',
			title: 'Space between',
			label: <Icon path={iAlignSB} size={iconSizeS} rotate={isRow ? 0 : 90} />,
		},
		{
			id: 'space-around',
			title: 'Space around',
			label: <Icon path={iAlignSA} size={iconSizeS} rotate={isRow ? 0 : 90} />,
		},
		{
			id: 'space-evenly',
			title: 'Space evenly',
			label: <Icon path={iAlignSE} size={iconSizeS} rotate={isRow ? 0 : 90} />,
		},
	]
	const optionsAlign = [
	...
	const optionsAlignContent = [
		...
		},
		{
			id: 'space-between',
			title: 'Space between',
			label: <Icon path={iAlignSB} size={iconSizeS} rotate={isRow ? 90 : 0} />,
		},
		{
			id: 'space-around',
			title: 'Space around',
			label: <Icon path={iAlignSA} size={iconSizeS} rotate={isRow ? 90 : 0} />,
		},
		{ id: 'stretch', title: 'Stretch', label: <Icon path={iAlignStr} size={iconSizeS} rotate={isRow ? 0 : 90} /> },
	]
	...
	const optionsFlex = [
		...
		{
			id: '1 1 0%',
			label: <Icon path={mdiUnfoldMoreHorizontal} size={iconSizeS} rotate={90} />,
			title: 'Fill container',
		},
		{
			id: '0 1 auto',
			label: <Icon path={mdiUnfoldLessHorizontal} size={iconSizeS} rotate={90} />,
			title: 'Hug contents',
		},
	]
	...
	return (
		<>
					...
					{propWrap.getValue() !== 'nowrap' && (
						<SectorRow>
							<PropertyLabel property={propAlignContent}>
								<ButtonGroupField
									{...getButtonsProps(propAlignContent)}
			...
			{isParentFlex && (
				<>
					<SectorRow separatorTop>{t('flexChild')}</SectorRow>
					<SectorRow>
