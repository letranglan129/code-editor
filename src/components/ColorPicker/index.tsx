...
export default function ColorPicker({ className, value, format = 'rgba', onChange }: Props) {
	...
	const clsMain = cx('bg-checker overflow-hidden cursor-pointer', className, br.b, br.rnd, cl.br)
