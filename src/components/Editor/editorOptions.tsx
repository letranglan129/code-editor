						...
						// Stack of backgrounds (Color - Gradient - Image/Patterns)
						{
							...
							properties: [
								...
								},
								{
									...
									properties: ['background-position-x', 'background-position-y'].map(prop => ({
										type: 'integer',
										property: prop,
										units: unitsSize,
										default: '0px',
								...
								},
								{
									...
									type: 'composite',
									properties: ['background-size-x', 'background-size-y'].map(prop => ({
										type: 'integer',
										property: prop,
										units: unitsSize,
										default: 'auto',
						...
						},
						{
							...
							layerLabel: (l: any, { values, property }: any) => {
								const label = property
									.getProperty('transform-name')
									.getOptionLabel(values['transform-name'])
